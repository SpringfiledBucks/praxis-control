...
| Gitea hook | `/data/git/repositories/<GITEA_OWNER>/praxis-control.git/hooks/post-receive.d/github-mirror` |
...
验收时必须确认本地 `HEAD`、Gitea `main` 与 GitHub `main` 三个 SHA 一致，并检查 GitHub 仓库保持私有。
